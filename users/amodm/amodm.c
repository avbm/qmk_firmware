...
#ifdef OLED_ENABLE
static char * current_base_layer_name = "Base3\0";
#endif
...
void u_td_fn_U_##LAYER(tap_dance_state_t *state, void *user_data) { \
  if (state->count == 2) { \
    char * layer_name = STRING; \
    current_base_layer_name = layer_name; \
...
static void oled_render_layer_state(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        case 0:
            oled_write_ln_P(current_base_layer_name, false);
            break;
        case 1:
        ...
        case 7:
            ...
            //oled_write_ln_P(PSTR(current_base_layer_name), false);
            break;
        case 8:
