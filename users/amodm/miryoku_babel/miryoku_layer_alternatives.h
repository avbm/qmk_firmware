...
LGUI_T(KC_C),      LALT_T(KC_I),      LCTL_T(KC_E),      LSFT_T(KC_A),      KC_COMM,           KC_DOT,            RSFT_T(KC_H),      RCTL_T(KC_T),      RALT_T(KC_S),      RGUI_T(KC_N),      \
...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              RGB_MOD,           KC_BRID,           KC_BRIU,           RGB_VAI,           RGB_TOG,           \
...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              RGB_TOG,           RGB_MOD,           KC_BRID,           KC_BRIU,           RGB_VAI,           \
